...
mds_plot_raw <- aamisc::ggMDS(mds = mds_raw, meta = d$samples, color.by = "Group", shape.by = "Region", legend.position = "right") +
...
mds_plot_blocked <- aamisc::ggMDS(mds = mds_blocked, meta = d$samples, color.by = "Group", shape.by = "Region", legend.position = "right") +
  scale_color_manual(values = publication_colors) +
...
mds_plot_combat <- aamisc::ggMDS(mds = mds_combat, meta = d$samples, color.by = "Group", shape.by = "Region", legend.position = "right") +
  scale_color_manual(values = publication_colors) +
...
# Differential Abundance Analysis with SVA and ComBat 
```{r}
