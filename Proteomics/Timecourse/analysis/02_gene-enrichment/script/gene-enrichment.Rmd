---
title: "Protein enrichment analysis"
...
contrasts <- c("Diff_Treatment", "Terminal_vs_Baseline_Control", "Terminal_vs_Baseline_Metformin", "Diff_Disease")
...
# # Saving the R object (05/11/2024)
# saveRDS(go_gsea_res_split, file = "../output/go_gsea_res_split.rds")

# Reloading the R object
go_gsea_res_split_test <- readRDS(file = "../output/go_gsea_res_split.rds")
...
#Plotting
contrasts <- c("Diff_Treatment", "Terminal_vs_Baseline_Control", "Terminal_vs_Baseline_Metformin", "Diff_Disease")
plot_dotplot_for_contrast(data_split = go_gsea_res_split_test, contrasts = contrasts)
