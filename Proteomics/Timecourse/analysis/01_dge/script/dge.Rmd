...
<!-- # Test on WSVA -->
<!-- ```{r} -->
<!-- design <- model.matrix(~ 0 + condition, data = d$samples)  # Full model -->
<!-- sv <- wsva(imputed_data_MinProb, design = design, n.sv = 1, weight.by.sd = TRUE, plot = TRUE) -->
<!-- finaldesign <- cbind(design, sv) -->
<!-- head(finaldesign) -->
...
mod <- model.matrix(~ 0 + condition, data = d$samples) #TO:Do 
